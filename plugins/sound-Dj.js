...
ptt: false, seconds: 0,contextInfo: {
 ...
 mediaUrl: 'www.instagram.com/Fahristeve1',
    mediaType: 2, 
    description: 'www.instagram.com/Fahristeve1',
    title: "Now Playing...",
    body: wm,
    thumbnail: await (await fetch('https://telegra.ph/file/b68838ac661b167465e31.jpg')).buffer(),
    sourceUrl: 'www.instagram.com/Fahristeve1'
}
     }
    })
}
