        ...
        for (let name in global.plugins) {
            ...
            if ((usedPrefix = (match[0] || '')[0])) {
                ...
                try {
                    ...
                    if (m.limit)
                        m.reply(+m.limit + " Limits Terpakai")
                }
                break
            }
        }
...
thumbnailUrl: "https://telegra.ph/file/0ccf051170b6bde1a554e.jpg",
sourceUrl: sgc,
mediaType: 1,
...
let msg = {
    ...
    premium: `Maaf, Perintah ini hanya bisa digunakan Oleh User Premium. Beli Premium ketik .premium`,
    group: `Maaf, Perintah ini hanya bisa digunakan di dalam Group`,
    private: `Perintah ini hanya bisa digunakan di Private Chat`,
    admin: `Perintah ini hanya bisa digunakan Admin Group`,
    botAdmin: `Jadikan Bot Admin untuk menggunakan Perintah tersebut`,
    ...
    restrict: `Maaf, Sepertinya vitur tersebut dimatikan oleh Owner Bot`
}[type]
